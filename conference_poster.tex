...
\par
When user first start any application, for example, NDNFit, a certificate will be requested and the user would be lead to identity manager.
The user may request for a new identity, or use current identity to generate a new certificate.
\par
